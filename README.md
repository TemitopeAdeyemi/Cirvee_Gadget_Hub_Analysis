...
The objective is to generate actionable business insights that can support customer retention strategies, revenue growth, and data-driven decision-making.
...
- Which locations generate the highest profit?
...
The raw dataset contained inconsistencies and required preprocessing before analysis.
...
4. Handled missing quantities by assuming a minimum of one unit per order
...
2. Calculated key metrics:
   ...
   - Purchase Frequency
   - Average Order Value
3. Segmented customers based on:
   - Spending Level (Very High, High, Low)
   - Purchase Frequency (Very Frequent, Frequent, Non-Frequent)
...
- Horizontal Bar Chart: Profit by City

An interactive Excel dashboard was designed to present insights clearly and intuitively.
...
- The business benefits from a broad customer base rather than reliance on a small number of customers.
